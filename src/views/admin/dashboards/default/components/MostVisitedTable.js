import { Icon, Flex, Table, Tbody, Td, Text, Th, Button, Thead, Tr, useColorModeValue } from '@chakra-ui/react';
                ...
                <Tr {...row.getRowProps()} key={index}>
                  {row.cells.map((cell, index) => {
                    ...
                    if (cell.column.Header === 'Page Name') {
                      ...
                      data = (
                        <Text color={cell.value[0] === '-' ? 'green.500' : 'red.500'} fontSize="sm" fontWeight="600">
                          {cell.value}
                        </Text>
                      );
                    }
