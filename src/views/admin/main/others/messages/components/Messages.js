  ...
  return (
    <Box h="100%" {...rest}>
      <Flex px="34px" pb="25px" borderBottom="1px solid" borderColor={borderColor} align="center">
        <Avatar h={{ base: '40px', '2xl': '50px' }} w={{ base: '40px', '2xl': '50px' }} src={avatar2} me="16px" />
        <Box>
      ...
      <Box h="calc(100% - 80px)" px={{ base: '10px', md: '20px' }} pt="45px" position="relative">
        ...
        >
          <Flex overflow="hidden">
            <Flex direction="column" w="100%" maxW={{ base: '90%', lg: 'calc(100% - 80px)' }} boxSizing="border-box">
          ...
          <Flex mb="50px" overflow="hidden" w="94%" ms="auto" justify="end">
            ...
            >
              <MessageBlock
                seen
                content={<span>Hello, Roberto! Hope you are fine! Let me take a look! Sounds interesting!</span>}
                time="09:23 PM"
              />
              <MessageBlock
                isLast
                ...
                content={
                  <span>
                    OMG!! It’s so innovative and awesome! I think I am going to buy it for my projects! It’s a game
                    changer!!🔥
                  </span>
                }
                time="09:25 PM"
