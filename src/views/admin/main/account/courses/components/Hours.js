...
export default function HoursSpent(props) {
  ...
  return (
    <Card border="1px solid" borderColor={borderColor} alignItems="center" flexDirection="column" w="100%" {...rest}>
      ...
      <Box h="240px" mt="auto">
        <BarChart chartData={barChartDataHoursSpent} chartOptions={newOptions} />
      </Box>
    </Card>
  );
}
