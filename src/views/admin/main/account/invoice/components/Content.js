...
export default function Content() {
  ...
  return (
    <Flex direction="column" p={{ base: '10px', md: '60px' }}>
      <Card backgroundRepeat="no-repeat" bg={bgCard} p="30px" mb="30px" mt="-100px">
        <Flex direction={{ base: 'column', md: 'row' }}>
          <Flex direction="column" me="auto" mb={{ base: '30px', md: '0px' }}>
            ...
            <Text w="max-content" mb="10px" fontSize="md" color="secondaryGray.600" fontWeight="400" lineHeight="26px">
              37 Avenue, Boggstown,
      ...
      <InvoiceTable tableData={tableDataInvoice} columnsData={tableColumnsInvoice} />
      <Flex mt="70px" direction={{ base: 'column', md: 'row' }}>
        <Box me="auto" mb={{ base: '40px', md: '0px' }}>
          ...
          <Text fontSize="md" fontWeight="400" color="secondaryGray.600" maxW="292px">
            Hi Anthony, please take a look at the this invoice from September. Let me know if you have any questions,
            thanks.
          </Text>
        </Box>
        <Box>
