  ...
  const panelExample = () => (
    <SimpleGrid columns="1" gap="40px" {...rest} maxW="100%" w={{ base: '100%', md: 'unset' }}>
      <Text fontSize="lg" color={textColorSecondary} fontWeight="400">
        Once you spend just a few hours learning the powerful proven Instagram marketing techniques, you will see why we
        are the recommend course. We have easy to follow step by step techniques to grow your followers and market your
        business.
      </Text>
      <Text fontSize="lg" color={textColorSecondary} fontWeight="400">
        Your time will pay off by reaching thousands of new customers, and building a strong, trustworthy relationship
        through Instagram will skyrocket your brand awareness to a level beyond your expectations. You will have the
        tools to create quality content, grow your Instagram followers and market your business to these hyper-targeted
        customers.
      </Text>
      <Text fontSize="lg" color={textColorSecondary} fontWeight="400">
        When making a purchasing decision, people online use your social media presence as a measure of the quality, and
        trustworthiness of your business. Nothing speaks trust and quality louder than having a thousands of targeted,
        real, and loving Instagram followers on your profile (of which you can contact at any time!) Your profile will
        be professional and compelling and you will be using stories, live streaming and all the other new features
        Instagram releases.
      </Text>
    </SimpleGrid>
  );
            ...
            <Tabs variant="soft-rounded" colorScheme="brandTabs" mb="60px">
              <TabList overflowX={{ sm: 'scroll', lg: 'unset' }}>
                <Flex>
                  ...
                  >
                    <Flex align="center">
                      <Text color={tabState === 'notes' ? textColor : textColorTertiary} fontSize="lg" fontWeight="500">
                        Notes
                      </Text>
                    </Flex>
                    <Box
                  ...
                  >
                    <Flex align="center">
                      <Text color={tabState === 'quiz' ? textColor : textColorTertiary} fontSize="lg" fontWeight="500">
                        Quiz (3)
                      </Text>
                    </Flex>
                    <Box
