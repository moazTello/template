    ...
    <Card p={{ base: '15px', md: '30px' }} {...rest}>
      <Box mb="45px" w="100%">
        <Flex justify="space-between" align="center" w="100%">
          <Flex>
            <SeeStory ps="0px" avatar={avatar} w="40px" h="40px" borderRadius="12px" />
      ...
      <Flex direction="column">
        ...
        <Box px={{ md: '20px' }}>
          ...
          <Flex align="center" position="relative">
            ...
            <Input variant="social" placeholder="Write your comment..." _focus={{ borderColor: 'blue.500' }} />
            <Box position="absolute" right="0px">
              {' '}
              <IconButton me="2px" px="0px" variant="no-hover" bg="transparent">
                <Icon as={MdOutlineAttachment} h="20px" w="20px" color="secondaryGray.700" transform="rotate(270deg)" />
              </IconButton>
              <IconButton me="2px" px="0px" variant="no-hover" bg="transparent">
