...
export default function YourOrderSteps(props) {
  ...
  return (
    <Card direction="column" w="100%" p="35px" flexDirection={{ base: 'column', md: 'row' }} {...rest}>
      ...
      <Flex flexDirection="column" mt={{ base: '20px', md: '0px' }}>
        ...
        <Link color={brandColor} href="#" textDecoration="underline" fontSize="md" fontWeight="500" lineHeight="26px">
