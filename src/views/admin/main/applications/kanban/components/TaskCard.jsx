import { Avatar, AvatarGroup, Badge, Flex, Text, Textarea, Icon, Image, useColorModeValue } from '@chakra-ui/react';
    ...
    return (
      ...
      >
        <Flex align="center" mb="20px">
          <Text fontWeight="700" fontSize="lg" color={textColor} onClick={toggleEditModeTitle}>
            {task.title}
          </Text>
          <Flex
            ms="auto"
            ...
            w="max-content"
          >
            <Icon color="secondaryGray.500" as={MdDeleteOutline} w="17px" h="17px" />
          </Flex>
          <Flex ms="6px" cursor="pointer" onClick={toggleEditModeTitle} h="max-content" w="max-content">
            <Icon color="secondaryGray.500" as={MdEdit} w="17px" h="17px" />
          </Flex>
        </Flex>{' '}
        {task.image ? <Image borderRadius="15px" w="420px" h="284px" src={task.image} mb="20px" /> : null}
        <Textarea
          w="100%"
          resize={'none'}
          borderRadius="16px"
