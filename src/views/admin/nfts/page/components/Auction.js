...
export default function Auction(props) {
  ...
  return (
    <Flex direction="column" ps={{ base: 'unset', lg: "'65px'" }} mx="auto" maxW={{ base: '100%', md: 'max-content' }}>
      <Text color={textColor} fontSize={{ base: '36px', '2xl': '54px' }} fontWeight="700" mb="-30px" lineHeight="100%">
        {name}
      </Text>
      <Flex>
        <Flex mt="55px" mb="36px" me="auto" justifyContent="center" alignItems="center">
          <Avatar h={{ base: '40px', md: '60px' }} w={{ base: '40px', md: '60px' }} src={creatorAvatar} me="20px" />
          <Box>
