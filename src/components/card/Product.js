  ...
  return (
    <Card p="20px">
      <Flex direction={{ base: 'column', '2xl': 'row' }}>
        ...
        />
        <Flex flexDirection="column" h="100%" align={{ base: 'center', '2xl': 'start' }} justify={{ base: 'center' }}>
          <Flex mb="25px" align="center">
            ...
            <Badge
              ...
              fontWeight="bold"
              color="white"
              bg={type.toLowerCase() === 'pro' ? 'linear-gradient(135deg, #868CFF 0%, #4318FF 100%)' : '#01B574'}
            >
              {type}
            </Badge>
          </Flex>
