...
import { AbalakLogo } from 'components/icons/Icons';
...
export default function HeaderLinks(props) {
  ...
  useEffect(() => {
    if (theme.colors.brand[500] === theme.colors.horizonPurple[500]) {
      setActive('Purple');
  ...
  return (
    <>
      ...
      <Drawer isOpen={isOpen} onClose={onClose} placement={dir === 'rtl' ? 'left' : 'right'} blockScrollOnMount={false}>
        <DrawerOverlay />
        <DrawerContent
          ...
          <DrawerHeader w={{ base: '100%', md: '400px' }} pt="24px" pb="0px" px="24px">
            ...
            <Flex alignItems="center">
              <Flex h="48px" w="48px" me="20px" borderRadius="999px" bgGradient="linear(to-b, brand.400, brand.600)">
                <AbalakLogo mt="7px" h="32px" w="50px" color="white" />
              </Flex>
              <Box>
          ...
          <DrawerBody pt="0px" pb="24px" w={{ base: '100%', md: '400px' }} maxW="unset">
            <Flex flexDirection="column">
              ...
              <SimpleGrid columns={2} gap="20px" mb="30px">
                ...
                >
                  <Image src={Light} maxW={{ base: '100%', md: '130px' }} borderRadius="8px" />
                </ConfiguratorRadio>
                <ConfiguratorRadio
                ...
                >
                  <Image src={Dark} maxW={{ base: '100%', md: '130px' }} borderRadius="8px" />
                </ConfiguratorRadio>
              </SimpleGrid>
              <Text color={textColor} mb="12px" fontWeight="700">
                Contrast
              ...
              <SimpleGrid columns={2} gap="20px" mb="30px">
                ...
                >
                  <Flex
                    ...
                    overflow="hidden"
                  >
                    <Image mt="auto" src={ContrastBlockImage} boxShadow={shadowBlock} />
                  </Flex>
                </ConfiguratorRadio>
                <ConfiguratorRadio
                  onClick={() => changeBgContrast()}
                  active={contrast !== false}
              ...
              <SimpleGrid columns={2} gap="20px" mb="30px">
                ...
                >
                  <Flex
                    ...
                    maxW={{ base: '100%', md: '130px' }}
                  >
                    <Image src={DefaultSidebarImage} maxW={{ base: '100%', md: '96px' }} boxShadow={shadowBlock} />
                  </Flex>
                </ConfiguratorRadio>
                <ConfiguratorRadio
                  onClick={() => props.setMini(true)}
                  active={props.mini !== false}
                ...
                >
                  <Flex
                    ...
                    overflow="hidden"
                  >
                    <Image src={MiniSidebarImage} maxW={{ base: '100%', md: '75px' }} boxShadow={shadowBlock} />
                  </Flex>
                </ConfiguratorRadio>
              </SimpleGrid>
              <Text color={textColor} mb="12px" fontWeight="700">
