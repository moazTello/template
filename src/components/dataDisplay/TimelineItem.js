...
export default function Default(props) {
  ...
  return (
    <Flex align="center" p="6px" borderRadius="20px" bg={current ? miniCardCurrent : miniCardNonCurrent} {...rest}>
      ...
      >
        <Text mb="2px" fontSize="md" fontWeight="500" color={current ? textSecondaryCurrent : textSecondaryNonCurrent}>
          {weekday}
        </Text>
      ...
      <Box>
        ...
        <Flex align="center">
          ...
          />
          <Text fontSize="sm" fontWeight="500" color={current ? textSecondaryCurrent : textSecondaryNonCurrent}>
            {hours}
          </Text>
        </Flex>
      </Box>
